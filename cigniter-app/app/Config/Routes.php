...
$routes->group('admin', function ($routes) {
    ...
    $routes->group('', ['filter' => 'cifilter:auth'], static function ($routes) {
        ...
        $routes->group('projects', function ($routes) {
            ...
            $routes->get('projects/new', 'ProjectController::new', ['as' => 'projects.new']);
            $routes->get('projects', 'ProjectController::index', ['as' => 'projects.list']);
            ...
            $routes->get('projects/(:num)/edit', 'ProjectController::edit/$1', ['as' => 'projects.edit']);
        ...
        $routes->group('tasks', function ($routes) {
            ...
            $routes->get('tasks/subtasks/(:num)', 'TaskController::showSubtasks/$1', ['as' => 'tasks.subtasks']);
        ...
        $routes->group('users', function ($routes) {
            ...
            $routes->post('update/(:num)', 'UserController::update/$1', ['as' => 'users.update']);
