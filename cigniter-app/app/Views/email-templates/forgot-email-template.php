...
<p>
    We are received a request to reset password for CIgestion projet  account with <i><?= $mail_data['user']->email ?></i>
    ...
    <a href="<?= $mail_data['actionLink'] ?>" style="color:#fff;border-color:#22bc66;border-style:solid;
     ...
     box-shadow:0 2px 3px rgba(0,0,0,0.16); -webkit-text-size-adjust: none; box-sizing: border-box;"
      target="_blank"›Reset passwords></a>
    <br><br>
    <b>NB: this link will still valid within 15 minutes.
    <br><br>
    If you did not request  for password reset, please ignore this mail
